...
int main(void)
{
    ...
    // Create LCD handle (RS, EN, D4, D5, D6, D7 in 4-bit mode)
...
{
    Lcd_cursor(&lcd, 0, 1);
    Lcd_string(&lcd, "PREM KUMAR\n");  // Line 1
    Lcd_cursor(&lcd, 1, 1);
    Lcd_string(&lcd, "123456789\n"); // Line 2

    // Example loop to print numbers
...
void SystemClock_Config(void)
{
    ...
    // Configure oscillator, clock, PLL here (default CubeMX generated content)
    // Example:
...
// GPIO Initialization (generated by CubeMX usually)
static void MX_GPIO_Init(void)
{
...
## Output screen shots of proteus  :
 <img width="1248" height="832" alt="Generated Image November 13, 2025 - 8_30AM" src="https://github.com/user-attachments/assets/711b2ff5-9e24-4142-ae0c-aa16a961556a" />


 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="1184" height="864" alt="Generated Image November 13, 2025 - 8_32AM" src="https://github.com/user-attachments/assets/340a3aae-a350-49a5-ba69-89a1124d8bd5" />


 
## Result :

Thus, to interfacing a lcd display with ARM microcontroller are simulated in proteus and the results are verified.
